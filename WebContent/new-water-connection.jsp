		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title">Customer Water Application Form</h3>
					<form action="NewWaterConnection" method="post">
						<div class="row">
							<div class="col-md-12">
								<%
								...
								<div class="alert alert-success" id="success">Customer
									Water account created successfully.</div>
								<%
									}
								%>
								<div class="panel">
									<div class="panel-heading">
										<h3 class="panel-title">Customer Water Application Form</h3>
									</div>
										...
										<div class="form-row">
											...
											<%
												String customerNo = DatabaseConnection.generateCusotmerNo();
													String waterNo = DatabaseConnection.geneateWaterNumber();
											%>
											<div class="form-group col-md-4">
											...
											<div class="form-group col-md-4">
												<label for="telephoneNo">Water No</label> <input type="text"
													id="waterNo" name="waterNo" value="<%=waterNo%>"
													placeholder="Water No" class="form-control" readonly>
											</div>
										</div>
										<div class="form-row">
